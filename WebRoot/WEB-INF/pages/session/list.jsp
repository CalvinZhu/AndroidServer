...
<%-- 		<c:forEach var="sess" items="${sessionList}">
			...
			<tr>
				<td><c:out value="task1" /></td>
				<td><c:out value="resource1" /></td>
				<td align="center"><c:out value="on" /></td>
				<td>
					<img src="images/user-online.png" />
					<c:out value="on" />
				</td>
				<td><c:out value="192.168.1.120" /></td>
				<td align="center"><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${sess.createdDate}" />2016-03-02</td>
			</tr>
			<tr>
				<td><c:out value="task2" /></td>
				<td><c:out value="resource2" /></td>
				<td align="center"><c:out value="off" /></td>
				<td>
					<img src="images/user-offline.png" />
					<c:out value="off" />
				</td>
				<td><c:out value="192.168.1.130" /></td>
				<td align="center"><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${sess.createdDate}" />2016-03-03</td>
			</tr>
	</tbody>
</table>
